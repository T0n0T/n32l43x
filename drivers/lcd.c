...
const uint32_t lcd_bit_define[CHAR_NUM_MAX][COM_NUM_MAX] = {
    ...
    {0x10000000, 0x00000000, 0x00000000}, // LCD_CHAR_CLOSE_ARROW
    {0x20000000, 0x70000000, 0x20000000}, // LCD_CHAR_BATTERY_4
    {0x20000000, 0x30000000, 0x20000000}, // LCD_CHAR_BATTERY_3
    {0x20000000, 0x10000000, 0x20000000}, // LCD_CHAR_BATTERY_2
    {0x20000000, 0x10000000, 0x00000000}, // LCD_CHAR_BATTERY_1
    {0x00000000, 0x10000000, 0x00000000}, // LCD_CHAR_BATTERY_0
};
