...
{
    xMasterRunRes = osSemaphoreNew(UINT_FAST16_MAX, 1, NULL);
}
...
{
    return osSemaphoreAcquire(xMasterRunRes, lTimeOut * osKernelGetTickFreq() / 1000) ? TRUE : FALSE;
}
...
eMBMasterReqErrCode eMBMasterWaitRequestFinish(void)
{
    ...
    osEventFlagsWait(xMasterOsEvent,
